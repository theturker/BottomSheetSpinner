...
internal class SpinnerBottomMenuDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleTextView1.setOnClickListener { dismiss() }
    }
    ...
    private fun initTitle() {
        ...
        titleTextView1.text = "Vazgeç"
        titleTextView.visibility = if (dialogTitle.isNullOrBlank()) GONE else VISIBLE
        titleTextView1.visibility = if (dialogTitle.isNullOrBlank()) GONE else VISIBLE
    }
    ...
    private fun makeFullHeight() {
        dialog?.let { dialog ->
            ...
            if (bottomSheet != null) {
                bottomSheet.layoutParams.height = 1300
